        ...
        <div class="row">
            ...
            <div class="card mr-5 mb-5" style="width: 20rem;">
                ...
                <div class="card-body">
                  ...
                  <hr>
                  <a class="btn btn-{{in_array(\Auth::user()->_id, $post->likes) ? "success":"primary"}}" href="{{ route('like', $post->_id) }}?route=profile"><span class="font-weight-bold text-{{sizeof($post->likes)>0 ? "warning":"danger"}}">{{sizeof($post->likes)}} </span><i class="fa fa-thumbs-up"> Like</i> </a>
