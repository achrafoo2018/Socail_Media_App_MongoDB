        ...
        <nav class="navbar fixed-top navbar-expand-md navbar-light bg-light shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{asset('storage/').'/uploads/logo.png'}}" width="150px" height="35px" alt="logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <form class="form-inline" style="margin-right: 150px;" method="GET">
                            <input class="form-control mr-sm-2" type="text" name="filter" value="{{isset($_GET['filter']) ? $_GET['filter']:""}}" placeholder="Search posts" aria-label="Search">
                        ...
                        <li class="nav-item mr-2    ">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('profile') }}?tab=settings">Settings</a>
